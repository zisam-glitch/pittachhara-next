...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { name: 'YouTube', href: '#', icon: 'M8.051 1.999h.089c.822.003 4.987.033 6.11.335a2.01 2.01 0 011.415 1.42c.101.38.172.883.22 1.402l.01.104.022.26.008.104c.065.914.073 1.77.074 1.957v.086c0 2.123-.186 3.828-.22 4.095a2.01 2.01 0 01-1.415 1.42c-.6.24-2.86.294-6.12.294s-5.52-.055-6.12-.294a2.01 2.01 0 01-1.415-1.42c-.124-.48-.21-1.176-.22-2.1v-.105c0-.39.01-.854.022-1.26l.008-.104.022-.26.01-.104c.048-.52.12-1.023.22-1.402a2.01 2.01 0 011.415-1.42c.72-.287 3.105-.33 6.11-.33l.089-.001zm6.03 6.388a1 1 0 00-1.415-1.586l-4.01 4.01a1 1 0 000 1.415l4.01 4.01a1 1 0 101.415-1.415l-3.302-3.303 3.302-3.302z' },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-[#0a2e1f]">Pittachara</h3>
            <p className="text-gray-600">
              Experience the next generation of digital entertainment and stay updated with our latest releases and news.
            </p>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <p className="text-center text-sm text-gray-500">
            &copy; {currentYear} Pittachara. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
